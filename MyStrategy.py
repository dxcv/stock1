...
if __name__ == '__main__':
    ...
    for i in range(3, len(date_seq)):
        ...
        if(but_flag):
            ...
            buy_sql = 'insert into my_stock_pool_buy (state_dt, stock_code, buy_price, hold_vol) VALUES(\'%s\', \'002415.SZ\', %s, %s)' % (date_seq[i],buy_price,buy_amout)
