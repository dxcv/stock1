...
class gtja_191:
    ...
    def __init__(self, start_date, end_date, codes):
        # security = get_index_stocks(index)
        price = jd.get_price_panel(codes, start_date, end_date)
...
if __name__ == '__main__':
    f = gtja_191(start_date='20180621', end_date='20190701', codes=['002871.SZ', '000002.SZ'])
